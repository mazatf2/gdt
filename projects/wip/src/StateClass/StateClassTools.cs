...
public class StateClassTools {
	public static string ToMermaid(IEnumerable<string> stateNames, projects.wip.StateClass.StateClass state) {
	...
	public static void ValidateConnections(projects.wip.StateClass.StateClass state) {
		Travel(state, (node) => {
	...
	public static void Travel(projects.wip.StateClass.StateClass node, Action<projects.wip.StateClass.StateClass> callback, List<projects.wip.StateClass.StateClass> visited = null) {
		visited ??= [];
